<%-- 
    Document   : TicketingOIC
    Created on : 11 3, 16, 4:22:06 PM
    Author     : see_h
--%>
...
<html>
    <head>
        <title>Safeguard | Tickets (OIC)</title>
        <!-- daterange picker -->
    ...
    <body>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col-xs-3">
                                                        ...
                                                        <input type = 'text' name = 'ViewTicketSubject' disabled id = 'ViewTicketSubject' disabled style="display:none"/>

                                                    </div>
                                                    <div class="form-group col-xs-2">
                                                        <label>Status</label>
                                                        <select class="form-control select2" disabled id="ViewTicketStatus" name="ViewTicketStatus" style="width: 100%;">
                                                    ...
                                                    <div class="form-group col-xs-3">
                                                        ...
                                                        <select class="form-control select2" disabled id="ViewTicketSeverity" name="ViewTicketSeverity" style="width: 100%;">
                                                    ...
                                                    <div class="form-group col-xs-12">
                                                        ...
                                                        <textarea class="form-control" disabled rows="3" id="ViewTicketActionTaken"></textarea>
                                                    </div>
                                                    <div class="modal-footer pull-right-container">
                                                        <span style="float:right;">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="table" data-target="#ViewTicket<%=+i%>" data-toggle="modal">
                                            ...
                                            <td><button type="submit" class="btn btn-primary" method="post" id="PrintTicket">Print</button></td>
                                        </tr>
                                        <% }
                                    }%>
                                    </tbody>
        ...
        <script src="/SRA/js/searchClientEmployees.js"></script>
