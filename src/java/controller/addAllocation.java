 ...
 */
@WebServlet(name = "addAllocation", urlPatterns = {"/addAllocation"})
public class addAllocation extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            String a = request.getParameter("employeeArrayHTML");
            String[] Array = a.split(",");
            
            boolean successful = false;
            int allocationID = employeeDAO.getAllocationID()+1;
            ...
            allocation.setStatus("Pending for Approval");
            successful = employeeDAO.inputAllocation(allocation);
            ...
            if (successful == true ){
                ...
                ServletContext context= getServletContext();
                RequestDispatcher rd= context.getRequestDispatcher("/AllocationNew.jsp");
                rd.forward(request, response);
            }
