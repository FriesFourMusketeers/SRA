...
public class EmployeeDAO {
    ...
    public ArrayList<EmployeePersonalInfo> getAllRejected() {
        try {
            ArrayList<EmployeePersonalInfo> personalList = new ArrayList();
            DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
            Connection conn = myFactory.getConnection();
            String query = "select * from `employee-personal-information` where status = 'Not Qualified'";
            PreparedStatement pstmt = conn.prepareStatement(query);
            ResultSet rs = pstmt.executeQuery();
    ...
    public ArrayList<EmployeePersonalInfo> getAllWaitlisted() {
        try {
            ...
            DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
            Connection conn = myFactory.getConnection();
            String query = "select * from `employee-personal-information` where status = 'Waitlisted'";
            PreparedStatement pstmt = conn.prepareStatement(query);
            ResultSet rs = pstmt.executeQuery();
