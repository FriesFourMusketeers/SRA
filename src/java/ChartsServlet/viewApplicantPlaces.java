 ...
 * @author see_h
 */
public class viewApplicantPlaces extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            charts = chartsDAO.viewAllApplicantsPlaces();
            ...
            for(int i = 0; i < charts.size(); i++){
                ...
                objChartsDAO.put("city", charts.get(i).getCity());
                objChartsDAO.put("count", charts.get(i).getCount());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(viewApplicantPlaces.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
