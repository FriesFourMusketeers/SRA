 ...
 * @author see_h
 */
public class viewApplicantBar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            charts = chartsDAO.viewAllApplicantsStatus();
            ...
            for(int i = 0; i < charts.size(); i++){
                ...
                objChartsDAO.put("status", charts.get(i).getStatus());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(viewApplicantBar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
