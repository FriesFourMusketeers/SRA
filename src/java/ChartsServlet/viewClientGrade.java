 ...
 * @author see_h
 */
public class viewClientGrade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.print(year + "the year clientchart");
            System.out.print(clientID + "the employee ID");
            charts = chartsDAO.getClientGradebyID(Integer.parseInt(year), Integer.parseInt(clientID));
...
//                objChartsDAO.put("empID", 3);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(viewClientGrade.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
